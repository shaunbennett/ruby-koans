...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # They consume as much as they possibly can in the string before stopping
  ...
  #
  # Character class matches everything inside of it while alternation selects one (like or)
