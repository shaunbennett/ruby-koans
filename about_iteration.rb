...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Inject runs a lambda on all elements in the array while keeping track of an injected
    # variable between each run. Saves needing to initialize your own variable
  end
  ...
  #
  # I imagine this has to do with handling file closing and errors. i.e. using the do after opening
  # the file will automatically close it in the case of an error or when the block is completed.
